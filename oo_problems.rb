...
#   def adopt_pet(pet)
#     @pets[pet.name] = pet unless @pets[pet.name]
#   end
...
#   def admit(pet)
#     @unadopted_pets[pet.name] = pet unless @unadopted_pets[pet.name]
#   end
...
#   def adopt(owner, pet)
#     @unadopted_pets.delete(pet.name)
#     owner.adopt_pet(pet)
...
#       puts "#{name} has adopted the following #{owner.number_of_pets} pets:"
#       owner.print_pets
#       puts
#     end
#   end
